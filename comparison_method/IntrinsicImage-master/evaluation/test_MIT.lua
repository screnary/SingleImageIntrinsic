...
--imgPath = '../../datasets/MIT/MIT-input-fullsize/'
imgPath = '../../datasets/MIT/MIT-input/'
saveDir = '../results/MIT/'

local file = '../../datasets/MIT/test.txt'
local files = {}
...
model = torch.load('../netfiles/model_MIT_combine_best.net')
model = model:cuda()
--model:training()
...
for _,file in ipairs(files) do
	...
	local savColor = string.gsub(file,'../../datasets/MIT/',saveDir)
	print(file)
	print(imgPath)
	print(saveDir)
	print(savColor)
