...
imgPath = '../../datasets/MPI/refined_gs/MPI-main-clean/'
...
for _,file in ipairs(files) do
	...
	local savColor = string.gsub(file,'../../datasets/MPI/refined_gs/',saveDir..'RD_')
	print('file: '..file)
        print('savColor0: ' .. savColor)
	savColor = saveDir.."/RD_MPI-main-clean/"..tostring(n)..".png"
