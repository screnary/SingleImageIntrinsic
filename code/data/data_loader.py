...
def CreateDataLoaderIIW(_root, _list_dir, mode, batch_size):
    data_loader = None
...
def CreateDataLoaderIIWTest(_root, _list_dir, mode, batch_size):
    data_loader = None
...
def CreateDataLoaderOpenSurfaces(_root, _list_dir, mode):
    data_loader = None
    from data.aligned_data_loader import OpenSurface_DataLoader
    data_loader = OpenSurface_DataLoader(_root, _list_dir, mode)
    return data_loader
