...
class IIWDataLoader(BaseDataLoader):
    def __init__(self,_root, _list_dir, mode, batch_size):
        # BaseDataLoader.initialize(self)
        # self.fineSize = opt.fineSize
        ...
        data_loader = torch.utils.data.DataLoader(dataset, batch_size=self.batch_size, shuffle= True, num_workers=int(0))
...
class IIWTESTDataLoader(BaseDataLoader):
    def __init__(self,_root, _list_dir, mode, batch_size):
        ...
        data_loader = torch.utils.data.DataLoader(dataset, batch_size=self.batch_size, shuffle= False, num_workers=int(0))
        self.dataset = dataset
