...
inputDir_1 = ['../../intrinsic_image_project/',...
    '/ckpoints-v8-3_self-sup+ms-MPI-main-RD-sceneSplit',...
    '-w_ssim-0.0-w_grad-0.0/log/'];
inputDir_2 = ['../../intrinsic_image_project/',...
    '/ckpoints-v8-3_self-sup+ms-MPI-main-RD-sceneSplit',...
    '-w_ssim-0.0-w_grad-1.0/log/'];
inputDir_3 = ['../../intrinsic_image_project/',...
    '/ckpoints-v8-3_self-sup+ms-MPI-main-RD-sceneSplit',...
    '-w_ssim-1.0-w_grad-0.0/log/'];
inputDir = inputDir_3;
