...
import my_data_RD_small as my_data
from configs.intrinsic_mpi_RD_small_v7 import opt
import trainer_mpi_RD_small_v7 as Trainer
...
RD: refined data, gray scale shading, I=A.*S; modified from v11
    ms+fd+pers
RD_small_v3: change Dilation Kernel=3 (from 5), decrease cosine portion in fd
    loss
RD_small_v6: change Dilation rates = [1,2,3]
RD_small_v7: use only conv1 features, check if have overlaps
"""
