...
from networks_mpi_RD_v7 import get_generator, get_discriminator, GANLoss, DivergenceLoss, PerspectiveLoss
from networks_mpi_RD_v7 import Grad_Img_v1 as Grad_Img
import pytorch_ssim
import copy
import pdb
...
class Trainer_Basic(nn.Module):
    ...
    def set_input(self, input_data):
        ...
        valid_thre_s = s_grad.abs().mean() * 0.35
        valid_thre_r = r_grad.abs().mean() * 0.35
