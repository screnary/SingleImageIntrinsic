...
from networks_mpi_RD_v12 import get_generator, get_discriminator, GANLoss, DivergenceLoss, PerspectiveLoss
from networks_mpi_RD_v12 import Grad_Img_v1 as Grad_Img
import pytorch_ssim
import copy
import pdb
...
class Trainer_Basic(nn.Module):
    ...
    def set_input(self, input_data):
        ...
        #pdb.set_trace()
        #input_i = self.padimg(input_i)
        #input_s = self.padimg(input_s)
        #input_r = self.padimg(input_r)
