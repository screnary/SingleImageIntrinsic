...
from configs.intrinsic_mpi_RD_small_v2 import opt
import trainer_mpi_RD_small_v2 as Trainer
...
RD: refined data, gray scale shading, I=A.*S; modified from v11
    ms+fd+pers
RD_small: small data for fast training, dilation rates all 1
RD_small_v2: use reflect padding
"""
