...
from configs.intrinsic_mit_v1 import opt
#from configs.intrinsic_mpi_RD_v8_new import opt
import trainer_mit as Trainer
...
intrinsic_mit: use for MIT dataset
intrinsic_mit_v1: continue train from MPI_RD_v8
"""
