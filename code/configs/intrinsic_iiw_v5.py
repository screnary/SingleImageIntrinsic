...
opt.train.mode = 'iiw-cross+fd+perc-v5'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.w_ss_dense = 1e-3                  # dense shading smooth loss         [4.0]
