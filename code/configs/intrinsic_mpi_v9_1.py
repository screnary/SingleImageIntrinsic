...
opt.train.mode = 'self-sup+ms+vgg19_v9_1-nograd'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.n_iter_decay = 3  # 30                # iterations to linearly decay learning rate to zero [100]
...
opt.optim.gradient_w = 0.0  # 1.5                  # weight of image gradient loss, [1.0]
