...
opt.data.name = 'MIT'                               # [MPI-main] the name of dataset [MPI, MIT] MPI-main
...
opt.train.mode = 'MIT_v1_continue-self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.fd_cosw = 0.3 #0.99                # for DivergenceLoss computation
