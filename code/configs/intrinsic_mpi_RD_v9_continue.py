...
opt.which_epoch = 200                  # Which epoch to recover
...
opt.train.mode = 'v9_self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.train.total_ep = 60  # 250, MIT-50
...
opt.optim.weight_decay = 0.00002             # weight decay
...
opt.optim.divergence_w = 0.01 #1.5                # 'fd', weight of feature divergence loss, [1.0]
