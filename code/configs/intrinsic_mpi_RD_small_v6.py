...
opt.train.mode = 'smallfortest_v6-self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.fd_cosw = 0.1 #0.99                # for DivergenceLoss computation
...
opt.optim.div_detail_dict = {'low':0.0, 'mid':0.0, 'deep': 1.0, 'out': 1.0}
