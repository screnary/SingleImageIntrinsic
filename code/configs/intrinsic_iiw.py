...
opt.optim.n_iter_decay = 10                # iterations to linearly decay learning rate to zero [100]
...
opt.optim.lr_g = 0.00002                     # initial learning rate for generator, [0.0001]
...
opt.optim.w_ss_dense = 2.0                  # dense shading smooth loss         [4.0]
...
if 'oneway' in opt.train.mode:
    ...
    opt.optim.pixel_suppress_w = 0.001
