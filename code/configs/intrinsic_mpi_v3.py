...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v3'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.identity_w = 50.0                  # weight of image identity loss
