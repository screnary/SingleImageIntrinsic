...
opt.train.mode = 'self-sup+ms+fd+vgg19_v8'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.perspective_w = 0.0               # 'pers', feature perspective loss
