...
opt.train.mode = 'v9-3_self-sup+ms'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.divergence_w = 0.0  # 0.01 #1.5                # 'fd', weight of feature divergence loss, [1.0]
