...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v1'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.train.epoch_count = 1                   # the starting epoch count: epoch_count += save_freq
