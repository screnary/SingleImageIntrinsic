...
opt.train.mode = 'iiw-oneway'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.train.total_ep = 10  # 250, MIT-50
...
opt.optim.perspective_w = 1.0               # feature perspective loss
...
opt.optim.w_reconstr_real = 2.0             # reconstruction Image loss weight  [2.0]
# opt.optim.w_rs_dense = 2.0
opt.optim.w_ss_dense = 4.0                  # dense shading smooth loss         [4.0]
opt.optim.w_IIW = 10.0                      # [4.0]
