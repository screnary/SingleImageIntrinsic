...
opt.train.mode = 'iiw-cross+fd+perc-v6'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.albedo_min = 0.10
opt.optim.shading_max = 0.90

opt.optim.iiw_cross_w = 0.01                 # cross loss total weight, set to be smaller!
opt.optim.preserve_info_w = 2.0             # regularization
opt.optim.pixel_suppress_w = 0.01              # penalize invalid pixels
...
opt.optim.w_ss_dense = 0.05                  # dense shading smooth loss         [4.0]
