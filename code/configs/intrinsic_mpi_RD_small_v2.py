...
opt.train.mode = 'smallfortest_v2-self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.n_layers = 2                  # number of conv blocks in decoder [4]
