...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v8'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.perspective_w = 1.5               # 'pers', feature perspective loss
