...
opt.train.mode = 'iiw-oneway+pixsupv2-v5'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.albedo_min = 0.10  # 0.03
opt.optim.shading_max = 0.87  # 0.97
