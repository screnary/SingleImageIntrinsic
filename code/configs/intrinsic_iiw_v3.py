...
opt.train.mode = 'iiw-cross+fd+perc-v3'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.threshold = 0.03
opt.optim.thre_decay = 0.25  # 0.65
...
opt.optim.pixel_suppress_w = 0.5              # penalize invalid pixels
