...
opt.which_epoch = 5                  # ['latest'/ 10] Which epoch to recover
...
opt.train.mode = 'iiw_v10-cross+fd+pers+vgg19'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.lr_g = 0.000025 # 0.00005                     # initial learning rate for generator, [0.0001]
...
opt.optim.div_detail_dict = {'low':0., 'mid':0., 'mid2':0., 'deep': 0.2, 'out': 0.8}
