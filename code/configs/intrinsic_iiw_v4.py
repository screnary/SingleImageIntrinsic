...
opt.train.mode = 'iiw-cross+fd+perc-v4'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.pixel_suppress_w = 0.0              # penalize invalid pixels
