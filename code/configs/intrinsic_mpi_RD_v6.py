...
opt.train.mode = 'v6_Twoway-ms+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.div_detail_dict = {'low':0.1, 'mid':0.2, 'deep': 0.5, 'out': 0.2}
