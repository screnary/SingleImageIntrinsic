...
opt.train.mode = 'saw_test-iiw_v7-oneway+pixsupv2+vgg19'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.train.save_per_n_ep_train = 1  # 10
