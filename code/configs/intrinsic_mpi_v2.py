...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v2'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.gradient_w = 0.5                  # weight of image gradient loss, [1.0]
