...
opt.train.mode = 'iiw-oneway+pixsupv2-v3'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.n_iter_decay = 7                  # iterations to linearly decay learning rate to zero [100]
...
opt.optim.w_ss_dense = 1.0 # 2.0                 # dense shading smooth loss         [4.0]
opt.optim.w_IIW = 3.0                      # [4.0]
...
if 'oneway' in opt.train.mode:
    ...
    opt.optim.pixel_suppress_w = 1.0  # 0.01
