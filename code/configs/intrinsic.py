...
opt.which_epoch = 'latest'                  # Which epoch to recover
...
opt.train.mode = 'self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.train.save_train_img = False
opt.train.save_per_n_ep = 10  # 10
opt.train.epoch_count = 1+100                   # the starting epoch count: epoch_count += save_freq
...
opt.optim.n_iter_decay = 30                # iterations to linearly decay learning rate to zero [100]
...
opt.optim.ssim_w = 5.0                      # weight of image SSIM loss
opt.optim.gradient_w = 5.0                  # weight of image gradient loss, [1.0]
