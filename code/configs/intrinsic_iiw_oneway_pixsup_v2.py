...
opt.train.mode = 'iiw-oneway+pixsupv2-v2'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.w_ss_dense = 1.5 # 2.0                 # dense shading smooth loss         [4.0]
...
if 'oneway' in opt.train.mode:
    ...
    opt.optim.pixel_suppress_w = 0.05  # 0.01
