...
opt.data.image_std = (1.0, 1.0, 1.0)       # image standard difference value  (0.2023, 0.1994, 0.2010)
#opt.data.image_std = (0.2023, 0.1994, 0.2010)       # image standard difference value  (0.2023, 0.1994, 0.2010)
...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v10'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
