...
opt.train.mode = 'iiw-oneway+pixsupv2+vgg19-v6_test'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.n_iter_decay = 10  # 1                # iterations to linearly decay learning rate to zero [100]
...
opt.optim.w_ss_dense = 0.1                  # dense shading smooth loss         [4.0]
