...
opt.train.mode = 'smallfortest_v4-self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.fd_cosw = 1.0 #0.99                # for DivergenceLoss computation
opt.model.gen.fd_normw = 0.0 #0.01
...
opt.optim.div_detail_dict = {'low':0.02, 'mid':0.04, 'deep': 0.5, 'out': 1.0}
...
opt.optim.divergence_w = 0.5 #1.5                # 'fd', weight of feature divergence loss, [1.0]
