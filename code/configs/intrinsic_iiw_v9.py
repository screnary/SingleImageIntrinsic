...
opt.which_epoch = 12                  # ['latest'/ 10] Which epoch to recover
...
opt.train.mode = 'iiw-cross+fd+perc+vgg19-v9'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.n_iter_decay = 1  # 1                # iterations to linearly decay learning rate to zero [100]
