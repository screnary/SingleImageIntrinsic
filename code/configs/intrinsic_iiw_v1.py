...
opt.train.mode = 'iiw-cross+fd+perc-v1'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
