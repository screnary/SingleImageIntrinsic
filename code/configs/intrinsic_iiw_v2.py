...
opt.train.mode = 'iiw-cross+fd+perc-v2'          # [iiw-oneway / iiw-cross+fd+perc]  train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
opt.train.trainer_mode = ''            # [Basic/GAN]
opt.train.pool_size = 1                    # image pool size
