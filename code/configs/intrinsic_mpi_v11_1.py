...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v11_1-onlyL1'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.ssim_w = 0. # 0.5                      # weight of image SSIM loss
opt.optim.gradient_w = 0.  #1.5                  # weight of image gradient loss, [1.0]

opt.optim.preserve_info_w = 0. #1.0             # try to constrain the tune
...
opt.optim.divergence_w = 0. #1.5                # 'fd', weight of feature divergence loss, [1.0]
opt.optim.perspective_w = 0. #1.0               # 'pers', feature perspective loss
