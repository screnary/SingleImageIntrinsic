...
opt.train.mode = 'self-sup+ms+pers+vgg19_v8'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.divergence_w = 0.0                # 'fd', weight of feature divergence loss, [1.0]
