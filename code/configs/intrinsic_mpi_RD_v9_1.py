...
opt.train.mode = 'v9-1_self-sup+ms+fd'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.fd_cosw = 0.2 #0.99                # for DivergenceLoss computation
...
opt.optim.divergence_w = 0.1  # 0.01 #1.5                # 'fd', weight of feature divergence loss, [1.0]
