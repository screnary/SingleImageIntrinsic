...
opt.train.mode = 'v7_self-sup+ms+fd+pers'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.model.gen.fd_normw = 0.2 #0.01
opt.model.gen.p_cosw = 0.0                  # for perspectiveLoss computation
opt.model.gen.p_normw = 1.0
...
opt.optim.div_detail_dict = {'low':0.1, 'mid':0.4, 'deep': 0.5, 'out': 0.6}
...
opt.optim.divergence_w = 0.25 #1.5                # 'fd', weight of feature divergence loss, [1.0]
