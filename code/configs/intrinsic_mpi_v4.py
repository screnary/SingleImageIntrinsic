...
opt.train.mode = 'self-sup+ms+fd+pers+vgg19_v4'                 # train generator mode [self-sup/none], [self-sup/cross-deconv/self-sup-ms]
...
opt.optim.div_detail_dict = {'low':0.01, 'mid':0.04, 'deep': 0.2, 'out':0.75}
